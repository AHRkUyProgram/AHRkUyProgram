...
<div id="map" class="flex-grow" style="width: 900px;height:
500px;"></div>
...
<div class="col-3">
<div class="card">
<div class="card-header bg-secondary text-light">Statistik</div>
<div class="card-body">
...
<td>:</td>
<td><?php echo
number_format($kabupaten->jumlah_penduduk,0,',','.').' Jiwa' ?></td>
</tr>
</tbody>
</table>
</div>
<div class="card-footer small bg-secondary text-light">
Sumber : BPS 2022
</div>
</div>
</div>
